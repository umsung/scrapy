...
from quotetutorail.items import JoBoleArticleItem
...
class ArticleSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for post_node in post_nodes:
            ...
            yield scrapy.Request(url=response.urljoin(post_url),meta={"front_image_url": response.urljoin(image_url)}, callback=self.parse_detail)
    ...
    def parse_detail(self,response):
        ...
        article_item["url_object_id"] = response.url #这里对地址进行了md5变成定长
