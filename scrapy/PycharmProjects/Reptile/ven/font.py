...
baseFonts = TTFont('font.woff')
baseFonts.saveXML('font.xml')


obj_list1=baseFonts.getGlyphNames()[1:-1]   #获取所有字符的对象，去除第一个和最后一个
print('obj_list1:', obj_list1)
# ['uniE0D3', 'uniE11F', 'uniE7A7', 'uniEB96', 'uniED89', 'uniEF34', 'uniEFB3', 'uniF430', 'uniF75F', 'uniF8AE']

uni_list1=baseFonts.getGlyphOrder()[2:]    #获取所有编码，去除前2个
...
print(baseFonts['glyf']['uniE7A7'].coordinates )